...
public class PlayerMeleeAttack : MonoBehaviour
{
    ...
    private void Start()
    {
        ...
        // Inicializar estad�sticas del ataque melee desde PlayerStatsManager o usar valores de fallback
        ...
        // Inicializar estad�sticas globales que afectan a todos los ataques desde PlayerStatsManager o usar valores fallback
    ...
    // Metodo para calcular las estad�sticas finales del ataque.
    ...
    // Funci�n que inicia el ataque cuerpo a cuerpo.
    private void Attack()
    {
        // Rota hacia el mouse justo cuando se inicia el ataque (cambio m�nimo solicitado)
    ...
    // Rota instant�neamente al mouse proyectado en el plano horizontal (y = transform.position.y)
...
//                ReportDebug("Golpe a " + enemy.name + " por " + finalDamageWithCrit + " de da�o.", 1);
//            }

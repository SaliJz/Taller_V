...
public class PlayerHealth : MonoBehaviour, IDamageable
{
    ...
    [Header("UI")]
    [SerializeField] private TMP_Text lifeStageText; // <-- a�adido: TextMeshPro que muestra la etapa de vida
    ...
    private void Start()
    {
        ...
        // --- Cambiado: forzar vida al m�ximo en Start para evitar iniciar con vida baja ---
    ...
    // Traduce el enum de LifeStage a una cadena en espa�ol para mostrar en TMP.

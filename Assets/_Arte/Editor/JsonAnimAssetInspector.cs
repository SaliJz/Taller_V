...
public class JsonAnimmAssetInspector : Editor
{
    ...
    void DrawSaveButtons()
    {
        EditorGUILayout.BeginHorizontal();
            ...
            // if(GUILayout.Button("Rebuild Asset"))
            // {
            //     JsonAnimAssetBuilder.Build(asset);
            // }
    ...
    {
        if(asset.animJson == lastLoadedAnimJson) return;
        ...
        if (UnsavedChanges)
        {
            ...
            switch (options)
            {
                ...
                case 1: asset.animJson = lastLoadedAnimJson; return;
                case 2: break;
            }
        }

        lastLoadedAnimJson = asset.animJson;
        loadJson();
    ...
    void DrawFramePreview()
    {
        ...
        // Rect previewRect = GUILayoutUtility.GetRect(10, 1000, 200, 200);
